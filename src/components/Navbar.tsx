        ...
        <nav className=" flex flex-row w-screen h-25 items-center gap-2 bg-[#173764] text-[#d4d3ce] justify-between">
           ...
           <div className="flex flex-row gap-2">
            ...
            <div className=" flex flex-row gap-2 items-center">
                <div>
                    <button onClick={changeLanguage} className="bg-[#FAFCFD] rounded-md px-6 py-2 flex flex-row items-center gap-2">
                        <IoLanguageOutline className="text-[#404c4e]"/>
                       <span className="text-[#000000]">PT/EN</span> 
                    </button>
                </div>
                <div>
                    <Link to='/Login' className="bg-[#E1B56F] rounded-md px-6 py-2 cursor-pointer text-[#0E284E] font-medium flex items-center gap-2 mr-4">
                        <span>
                            <span>{t("login")}</span>
                        </span>
                        <IoIosArrowRoundForward className="text-[#0E284E] h-4 w-4 md:h-5 md:w-5" />
                    </Link>
